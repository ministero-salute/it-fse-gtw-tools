...
public final class LDOValidator extends DocumentTypeValidator {
	...
	private static void motivo(List<ErrorUCTDTO> errors, String xml) {
		...
		ValidationXML.equalIC(errors, LDOErrorEnum.MOTIVO_OBS_VALUE_CODE, xml, "ClinicalDocument > component > structuredBody > component > section[ID='Motivo_Ricovero'] > entry > observation > value", "code", "300.01");
