...
//		ValidationXML.equalIC(errors, RADErrorEnum.T019, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > entry > observation > entryRelationship > observation > code", "code", "89261-2","33999-4");
//		ValidationXML.equalIC(errors, RADErrorEnum.T020, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > entry > observation > entryRelationship > observation > code", "codeSystem", "2.16.840.1.113883.6.1");
...
//		ValidationXML.equalIC(errors, RADErrorEnum.T033, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > entry > organizer > component > observation > entryRelationship", "typeCode", "SUBJ");
//		ValidationXML.equalIC(errors, RADErrorEnum.T034, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > entry > organizer > component > observation > entryRelationship > observation", "moodCode", "EVN");
...
//		ValidationXML.hasDateFormat(errors, RADErrorEnum.T055, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > component > section[ID=Allergie] > entry > act > entryRelationship > observation > entryRelationship > observation > effectiveTime", "value");
//		ValidationXML.equalIC(errors, RADErrorEnum.T057, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > component > section[ID=Allergie] > entry > act > entryRelationship > observation > entryRelationship > act > code", "code", "48767-8");
//		ValidationXML.equalIC(errors, RADErrorEnum.T058, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > component > section[ID=Allergie] > entry > act > entryRelationship > observation > entryRelationship > act > code", "codeSystem", "2.16.840.1.113883.6.1");
//		ValidationXML.equalIC(errors, RADErrorEnum.T059, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Storia_Clinica] > component > section[ID=Allergie] > entry > act > entryRelationship > observation > entryRelationship > act > statusCode", "", "completed");
...
//	    ValidationXML.hasDateFormat(errors, RADErrorEnum.T206, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Complicanze] > entry > observation > effectiveTime", "value");
//	    ValidationXML.hasDateFormat(errors, RADErrorEnum.T207, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Complicanze] > entry > observation > effectiveTime > low", "value");
//	    ValidationXML.hasDateFormat(errors, RADErrorEnum.T208, xml, "ClinicalDocument > component > structuredBody > component > section[ID=Complicanze] > entry > observation > effectiveTime > high", "value");
